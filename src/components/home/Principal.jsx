        ...
        <main className='fundo'>
            ...
            <div className='games'>
                <div className='game-list'>
                    ...
                    <button onclick="popHabilitacaob()" type="button" id="btnHabilitacaoba" class="buttonEnviar" data-toggle="modal" data-target="#ExemploModalCentralizado">Solicite o orçamento</button>
                </div>
                <div className='game-list'>
                    ...
                    <button onclick="popHabilitacaoa()" type="button" id="btnHabilitacaob" class="buttonEnviar" data-toggle="modal" data-target="#ExemploModalCentralizado">Solicite o orçamento</button>
                ...
                <div className='game-list'>
                    ...
                    <h3>Adição</h3>
                    <button type="button" class="buttonEnviar" data-toggle="modal" data-target="#ExemploModalCentralizado">Solicite o orçamento</button>
