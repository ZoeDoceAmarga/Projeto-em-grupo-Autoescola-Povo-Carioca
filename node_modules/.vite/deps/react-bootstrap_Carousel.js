...
var defaultProps = {
  ...
  wrap: true,
  touch: true,
  prevIcon: (0, import_jsx_runtime6.jsx)("span", {
    "aria-hidden": "true",
    className: "carousel-control-prev-icon"
  }),
  prevLabel: "Previous",
  nextIcon: (0, import_jsx_runtime6.jsx)("span", {
    "aria-hidden": "true",
...
var Carousel = React10.forwardRef((uncontrolledProps, ref) => {
  const {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component = "div",
    bsPrefix,
  ...
  return (0, import_jsx_runtime7.jsxs)(Component, {
    ref: elementRef,
    ...props,
    onKeyDown: handleKeyDown,
    ...
    children: [indicators && (0, import_jsx_runtime6.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime6.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime6.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React10.cloneElement(child, {
            ...innerProps,
        ...
        }) : React10.cloneElement(child, {
          className: (0, import_classnames3.default)(child.props.className, isActive && "active")
        });
      })
    }), controls && (0, import_jsx_runtime7.jsxs)(import_jsx_runtime8.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime7.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime6.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime7.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime6.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
